...
PERSON_PRETITLES = set([
    ...
    'madame', 'maam', 'ma am', 'dame', 'lord', 'lady', 'the honourable',
    'the honorable', 'the right honourable', 'the right honorable',
    'the most honourable', 'the most honorable', 'the hon', 'hon', 'dr',
    'doctor', 'professor', 'excellency', 'his excellency', 'her excellency',
    'chancellor', 'vice chancellor', 'principal', 'president', 'warden', 'dean',
    'regent', 'rector', 'provost', 'director', 'chief executive',
    'his holiness', 'hh', 'pope', 'pope emeritus', 'his all holiness', 'hah',
    'his beatitude', 'his most eminent highness', 'hmeh', 'his eminence', 'he',
