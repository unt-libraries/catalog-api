...
@pytest.mark.parametrize('marcfields, exp_ps, exp_pyd, exp_py, exp_pds', [
    ...
    ([('008', 's199u    ')],
     '199-', '1990s', ['199-'], ['199-']),
    ([('008', 's19uu    ')],
     '19--', '20th century', ['19--'], ['19--']),
    ([('008', 's1uuu    ')],
     '1---', 'dates unknown', ['1---'], ['1---']),
    ([('008', 'q198u1990')],
     '198-', '1980s to 1990', ['198-'], ['198-']),
    ([('008', 'q15uu17uu')],
     '15--', '16th to 18th century', ['15--'], ['15--']),
    ([('008', 's2004    '),
      ('260', ['a', 'Place :', 'b', 'Publisher,', 'c', '[199-?]'])],
     '2004', '2004', ['2004', '199-'], ['2004', '199-']),
    ([('008', 's2004    '),
      ('260', ['a', 'Place :', 'b', 'Publisher,', 'c', '[1990s?]'])],
     '2004', '2004', ['2004', '199-'], ['2004', '199-']),
    ([('008', 's2004    '),
      ('260', ['a', 'Place :', 'b', 'Publisher,', 'c', '[19--?]'])],
     '2004', '2004', ['2004', '19--'], ['2004', '19--']),
    ([('008', 's2004    '),
      ('260', ['a', 'Place :', 'b', 'Publisher,', 'c', '[21st century]'])],
     '2004', '2004', ['2004', '20--'], ['2004', '20--']),
], ids=[
