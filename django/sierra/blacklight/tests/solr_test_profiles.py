...
ALPHASOLRMARC_FIELDS = (
    ...
    'isbns_display', 'issns_display', 'lccn_display', 'oclc_numbers_display',
...
ALPHASOLRMARC_GENS = (
    ...
    ('game_facet', GENS(tp.multi(GENS.type('string', mn=6, mx=10,
                                           alphabet=tp.LETTERS_LOWER + 
                                                    tp.NUMBERS), 1, 3))),
    ('languages', 'auto'),
    ('isbns_display', GENS(tp.chance(tp.multi(tp.isbn_number, 1, 5), 66))),
    ('issns_display', GENS(tp.chance(tp.multi(tp.issn_number, 1, 5), 33))),
    ('lccn_display', GENS(tp.chance(GENS.type('int', mn=100000,
                                              mx=999999999999), 80))),
    ('oclc_numbers_display', GENS(tp.chance(tp.multi(tp.oclc_number, 1, 2),
                                            75))),
