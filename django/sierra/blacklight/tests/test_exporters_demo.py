"""
Tests the `blacklight.exporters_demo` classes.
"""
...
def test_bibs_to_blacklight_demo(sierra_records_by_recnum_range,
                                 export_to_solr):
    """
    ...
    results = export_to_solr('bl-demo', record_set, 'BibsToBlacklightDemo')
