...
def test_todscpipeline_interpretcodeddate(ldr_07, f008_06, date1, date2,
                                          expected, todsc_pipeline_class):
    """
    ToDiscoverPipeline.interpret_coded_date should return the expected
    values, given the provided parameters.
    """
    pipeline = todsc_pipeline_class()
    mr = s2m.SierraMarcRecord()
...
@pytest.mark.parametrize('ldr_07, fparams, exp_pub_sort, exp_pub_year_display, '
    ...
    ('m', [('008', 'b2004    ')],
     '2004', '2004', [2004], ['2004']),
    ('s', [('008', 'c20189999')],
     '2018', '2018 to present', [2018, 2019, 2020, 2021],
     ['2018', '2019', '2020', '2021']),
    ('s', [('008', 'd20142016')],
     '2014', '2014 to 2016', [2014, 2015, 2016], ['2014', '2015', '2016']),
    ('s', [('008', 'd20142016'),
    ...
    ('m', [('008', 'q20042005')],
     '2004', '2004 to 2005', [2004, 2005], ['2004', '2005']),
    ('m', [('008', 'r20042016')],
...
def test_todscpipeline_getpubinfo_dates(ldr_07, fparams, exp_pub_sort,
...
def test_todscpipeline_getpubinfo_statements(ldr_07, fparams, expected,
                                             bl_sierra_test_record,
                                             todsc_pipeline_class,
                                             bibrecord_to_pymarc,
                                             params_to_fields, add_marc_fields,
...
def test_todscpipeline_getpubinfo_pub_search(ldr_07, fparams, expected,
                                             bl_sierra_test_record,
                                             todsc_pipeline_class,
                                             bibrecord_to_pymarc,
                                             params_to_fields,
...
@pytest.mark.parametrize('this_year, pyears, bib_type, expected', [
    (2020, [2020], '-', '1000'),
    (2021, [2020], '-', '1000'),
    (2020, [2020], 'd', '1000'),
    (2020, [2019], '-', '999'),
...
def test_todscpipeline_getrecordboost(this_year, pyears, bib_type,
                                      expected, bl_sierra_test_record,
    ...
    bib = bl_sierra_test_record('bib_no_items')
    bibmarc = bibrecord_to_pymarc(bib)
    pipeline.bundle['publication_year_range_facet'] = pyears
