...
class S2MarcBatchAlphaSolrmarc(S2MarcBatch):
    
    """
    Sierra to MARC converter for the Blacklight alpha-solrmarc site.
    """
...
class BibsDownloadMarcAlphaSolrmarc(BaseBibsDownloadMarc):
    
    s2marc_batch_class = S2MarcBatchAlphaSolrmarc


class BibsToAlphaSolrmarc(BaseSolrMarcBibsToSolr):
    
    bib2marc_class = BibsDownloadMarcAlphaSolrmarc
