...
@pytest.mark.parametrize('loc_code, expected', [
    ...
    ('czmrf', ['Media Library']),
    ('czwww', ['Media Library']),
    ('fip', ['Frisco Collection']),
    ('fl', ['Frisco Collection']),
    ('flrs', ['Frisco Collection']),
    ('flgrn', ['Frisco Collection']),
    ('frsco', ['Frisco Collection']),
    ('flmak', ['Frisco Collection', 'The Spark (Makerspace)']),
    ('flind', ['Frisco Collection', 'The Spark (Makerspace)']),
    ('flix', ['Frisco Collection', 'The Spark (Makerspace)']),
    ('jlf', ['General Collection']),
    ('lwww', ['General Collection']),
    ('w', ['General Collection']),
    ('w3', ['General Collection']),
    ('wllok', ['General Collection']),
...
@pytest.mark.parametrize('bcode2, cns, f007s, f008_21, f008_23, f008_26, '
    ...
    ('g', ['ABC 2005 DVD'], ['vdv|vaiz|'], None, None, None, None,
     'video_dvd'),
    ('g', ['ND 359 .N37 ABC 2005 DVD'], ['vdv|vaiz|'], None, None, None, None,
     'video_dvd'),
    ('g', ['DVD 1234 Blu-ray'], ['vdb|saiz|'], None, None, None, None,
     'video_bluray'),
    ('g', ['ABC 2020 BLU'], ['vdb|saiz|'], None, None, None, None,
     'video_bluray'),
    ...
    ('m', ['Game 12'], ['cor|ga||||||||'], None, None, None, None,
     'game_console'),
    ('m', ['MT 2002 GAME'], ['cor|ga||||||||'], None, None, None, None,
     'game_console'),
    ...
    ('m', ['Game 12 PS4'], ['cor|ga||||||||'], None, None, None, None,
     'game_console!PS4'),
    ('m', ['ABC 2016 GAME PS4', 'Game 12 PS4'], ['cor|ga||||||||'], None, None,
     None, None, 'game_console!PS4'),
    ('m', ['ABC 2016 GAME PS4'], ['cor|ga||||||||'], None, None, None, None,
     'game_console!PS4'),
    ('m', ['Game 12 XBox 360'], ['cor|ga||||||||'], None, None, None, None,
     'game_console!Xbox 360'),
    ('m', ['A B C 2016 GAME XBOX 360'], ['cor|ga||||||||'], None, None, None,
     None, 'game_console!Xbox 360'),
    ...
    ('m', 
     ['ABC 2016 GAME PSP', 'ABC 2016 GAME GAMEBOY', 'Game 12 PSP', 
      'Game 12 Gameboy'],
     ['cbh|ga||||||||'], None, None, None, None, 'game_handheld!Gameboy, PSP'),
    ...
    ('r', ['Boardgame 1234', 'MYS 2016 GAME'], None, None, None, ' ', ['czm'],
     'game_tabletop'),
    ('r', ['MYS 2016 GAME'], None, None, None, ' ', ['czm'], 'game_tabletop'),
    ('r', ['GOL 2020 TAROT', 'Boardgame 1234'], None, None, None, ' ', ['czm'],
     'game_tabletop!Tarot Cards'),
    ('r', ['GOL 2020 TAROT'], None, None, None, ' ', ['czm'],
     'game_tabletop!Tarot Cards'),
...
@pytest.mark.parametrize('rtypes, fmts, exp_rtypes, exp_mtypes', [
    ...
    (['game', 'tabletop'], [], ['objects_artifacts', 'games'],
     ['Tabletop Games']),
    (['game', 'tabletop'], ['tarot'], ['objects_artifacts', 'games'],
     ['Tabletop Games', 'Tarot Cards']),
    (['score', 'thesis'], ['print'],
